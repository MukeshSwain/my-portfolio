  ...
  return (
    ...
    >
      ...
      <p className="mt-6 max-w-2xl mx-auto text-gray-700 text-base sm:text-lg">
        Building secure, scalable, and intelligent web applications using MERN,
        real-time technologies, and AI integrations.
      </p>
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-4">
        ...
        <a
          ...
          className="flex items-center justify-center border border-indigo-600 px-3 py-2 rounded-md text-indigo-600 hover:bg-indigo-50 transition text-xl"
        >
          <FaGithub />
        </a>
      </div>
